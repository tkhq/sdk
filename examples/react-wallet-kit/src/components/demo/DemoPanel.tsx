  ...
  return (
    ...
    >
          ...
          <MenuButton className="relative text-left text-xl group p-2 gap-3 flex items-center w-fit">
            <div className="flex flex-col w-full">
              <div className="flex items-center justify-between w-full gap-4">
                <p className="text-base max-w-[5dvw] truncate font-medium">
            ...
            <MenuItem>
              <Button
                onClick={async () => {
                  ...
                  setSelectedWalletAccount(newWallet.accounts[0] || undefined);
                }}
      ...
      <div className="flex justify-between items-center gap-4">
        ...
        >
          <FontAwesomeIcon icon={faArrowDown} className="w-4 h-4 mr-2" /> Import
          Wallet
        </Button>
      </div>
    </div>
