...
This example includes API stubs to get your private keys and export your private key. The creation of the iframe is abstracted by our `@turnkey/iframe-stamper` package.
