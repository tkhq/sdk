...
export default function ProtectedPage() {
  ...
  const clearPaymentSession = () => {
    document.cookie = "payment-session=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-800 text-white text-center">
      <div className="max-w-2xl mx-auto p-8">
        ...
        <p className="mt-3">
          You used a Turnkey embedded wallet to pay for this page! <br /> You will be able to access
          this page for 5 minutes. If you want to clear your token before then, click the button
          below.
        </p>
