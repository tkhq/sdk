...
| `approval`  | `APPROVAL_RECIPIENT` | 2-of-2 consensus               | Sits in `CONSENSUS_NEEDED` until you approve in the browser |
...
Setup tab: "Setup agent" ──────────────────────────────►
                        ...
                        Creates Policy B (needs approval)
...
The agent's submission is vote 1. The activity sits in `CONSENSUS_NEEDED` until the root user clicks Approve (vote 2).
