...
[SDK Documentation](../../packages.mdx) / @turnkey/react-native-passkey-stamper
...
- [AuthenticatorTransport](enumerations/AuthenticatorTransport.mdx)

## Classes

- [PasskeyStamper](classes/PasskeyStamper.mdx)

## Interfaces

- [PublicKeyCredentialDescriptor](interfaces/PublicKeyCredentialDescriptor.mdx)
...
- [TurnkeyAuthenticatorParams](type-aliases/TurnkeyAuthenticatorParams.mdx)

## Functions

- [createPasskey](functions/createPasskey.mdx)
- [isSupported](functions/isSupported.mdx)
