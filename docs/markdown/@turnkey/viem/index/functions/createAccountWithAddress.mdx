...
[SDK Documentation](../../../../packages.mdx) / [@turnkey/viem](../../README.mdx) / [index](../README.mdx) / createAccountWithAddress

# Function: createAccountWithAddress()

> **createAccountWithAddress**(`input`): `object`

Defined in: [packages/viem/src/index.ts:77](https://github.com/tkhq/sdk/blob/fd49bfe86475c8603b3eb385aa101efa36fa32fc/packages/viem/src/index.ts#L77)
