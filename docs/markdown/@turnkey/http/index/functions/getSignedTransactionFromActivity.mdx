...
[SDK Documentation](../../../../packages.mdx) / [@turnkey/http](../../README.mdx) / [index](../README.mdx) / getSignedTransactionFromActivity

# Function: getSignedTransactionFromActivity()

> **getSignedTransactionFromActivity**(`activity`): `string`

Defined in: [packages/http/src/shared.ts:182](https://github.com/tkhq/sdk/blob/078f5423e923fbd1d7fd39440402d7f01d09c3d0/packages/http/src/shared.ts#L182)
