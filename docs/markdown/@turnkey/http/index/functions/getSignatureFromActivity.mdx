...
[SDK Documentation](../../../../packages.mdx) / [@turnkey/http](../../README.mdx) / [index](../README.mdx) / getSignatureFromActivity

# Function: getSignatureFromActivity()

> **getSignatureFromActivity**(`activity`): `object`

Defined in: [packages/http/src/shared.ts:131](https://github.com/tkhq/sdk/blob/078f5423e923fbd1d7fd39440402d7f01d09c3d0/packages/http/src/shared.ts#L131)
