...
[SDK Documentation](../../../packages.mdx) / [@turnkey/http](../README.mdx) / getSignedTransactionFromActivity

# Function: getSignedTransactionFromActivity()

> **getSignedTransactionFromActivity**(`activity`): `string`

Defined in: [packages/http/src/shared.ts:182](https://github.com/tkhq/sdk/blob/e1b1a69bdd608320aaf03cc2dbbf68dc0c52b28d/packages/http/src/shared.ts#L182)
