...
[SDK Documentation](../../../packages.mdx) / [@turnkey/http](../README.mdx) / assertActivityCompleted

# Function: assertActivityCompleted()

> **assertActivityCompleted**(`activity`): `boolean`

Defined in: [packages/http/src/shared.ts:84](https://github.com/tkhq/sdk/blob/e1b1a69bdd608320aaf03cc2dbbf68dc0c52b28d/packages/http/src/shared.ts#L84)
