...
[SDK Documentation](../../../packages.mdx) / [@turnkey/http](../README.mdx) / getSignaturesFromActivity

# Function: getSignaturesFromActivity()

> **getSignaturesFromActivity**(`activity`): `object`[]

Defined in: [packages/http/src/shared.ts:159](https://github.com/tkhq/sdk/blob/e1b1a69bdd608320aaf03cc2dbbf68dc0c52b28d/packages/http/src/shared.ts#L159)
