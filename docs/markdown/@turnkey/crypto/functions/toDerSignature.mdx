...
[SDK Documentation](../../../packages.mdx) / [@turnkey/crypto](../README.mdx) / toDerSignature

# Function: toDerSignature()

> **toDerSignature**(`rawSignature`): `string`

Defined in: [crypto.ts:584](https://github.com/tkhq/sdk/blob/fd49bfe86475c8603b3eb385aa101efa36fa32fc/packages/crypto/src/crypto.ts#L584)
