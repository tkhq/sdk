...
[SDK Documentation](../../../packages.mdx) / [@turnkey/crypto](../README.mdx) / decryptExportBundle

# Function: decryptExportBundle()

> **decryptExportBundle**(`params`): `Promise`\<`string`\>

Defined in: [turnkey.ts:103](https://github.com/tkhq/sdk/blob/3a88af7d1d927c6022706911d6af0f92f1440e00/packages/crypto/src/turnkey.ts#L103)
