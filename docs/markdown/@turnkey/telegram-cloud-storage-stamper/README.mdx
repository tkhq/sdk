...
[SDK Documentation](../../packages.mdx) / @turnkey/telegram-cloud-storage-stamper
...
- [TelegramCloudStorageStamper](classes/TelegramCloudStorageStamper.mdx)
...
- [DEFAULT\_TURNKEY\_CLOUD\_STORAGE\_KEY](variables/DEFAULT_TURNKEY_CLOUD_STORAGE_KEY.mdx)
