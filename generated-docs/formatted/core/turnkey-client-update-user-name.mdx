...
<ul>
  ...
  <li>
    If a userId is provided, it updates the name for that specific user;
...
<p>
  ...
  <a href="https://github.com/tkhq/sdk/blob/main/packages/core/src/__clients__/core.ts#L2688">
    core.ts:2688
  </a>
</p>
...
<ParamField body="params" type="object" required={true} path="params">
  <Expandable title="params details">
    ...
    <NestedParam
      ...
      required={false}
    >
      user ID to update a specific user's name (defaults to the current
      session's userId).
    </NestedParam>
    <NestedParam
      parentKey="params"
