...
<p><strong>Defined in:</strong> <a href="https://github.com/tkhq/sdk/blob/main/packages/core/src/__clients__/core.ts#L2761">core/src/__clients__/core.ts:2761</a></p>

<H3Bordered text="Parameters" />

<ParamField body="params" type='RemoveUserEmailParams' required={false} >
