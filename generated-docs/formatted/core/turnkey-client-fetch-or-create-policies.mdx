...
<p><strong>Defined in:</strong> <a href="https://github.com/tkhq/sdk/blob/main/packages/core/src/__clients__/core.ts#L2572">core/src/__clients__/core.ts:2572</a></p>

<H3Bordered text="Parameters" />

<ParamField body="params" type='FetchOrCreatePoliciesParams' required={true} >
...
<ResponseField name="returns" type="FetchOrCreatePoliciesResult" required={true} >
