...
<p><strong>Defined in:</strong> <a href="https://github.com/tkhq/sdk/blob/main/packages/core/src/__clients__/core.ts#L443">core/src/__clients__/core.ts:443</a></p>
...
<ResponseField name="returns" type="PasskeyAuthResult" required={true} >
  ...
  <Expandable title="return details">
    <NestedParam parentKey="returns" childKey="credentialId" type='string' required={true}></NestedParam>
    <NestedParam parentKey="returns" childKey="sessionToken" type='string' required={true}></NestedParam>
  </Expandable>
</ResponseField>
