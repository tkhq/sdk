...
<p><strong>Defined in:</strong> <a href="https://github.com/tkhq/sdk/blob/main/packages/core/src/__clients__/core.ts#L2873">core/src/__clients__/core.ts:2873</a></p>

<H3Bordered text="Parameters" />

<ParamField body="params" type='RemoveUserPhoneNumberParams' required={false} >
