...
<ul>
  <li>
    This function removes OAuth providers (e.g., Google, Apple) from the user's
    account.
  </li>
  <li>
    If a userId is provided, it removes the providers for that specific user;
  ...
  <li>
    Returns an array of remaining provider IDs associated with the user after
    removal.
  </li>
</ul>
...
<p>
  ...
  <a href="https://github.com/tkhq/sdk/blob/main/packages/core/src/__clients__/core.ts#L2851">
    core.ts:2851
  </a>
</p>
...
<ParamField body="params" type="object" required={true} path="params">
  <Expandable title="params details">
    ...
    <NestedParam
      ...
      required={false}
    >
      user ID to remove the provider for a specific user (defaults to the
