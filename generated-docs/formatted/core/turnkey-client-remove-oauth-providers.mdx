...
<p><strong>Defined in:</strong> <a href="https://github.com/tkhq/sdk/blob/main/packages/core/src/__clients__/core.ts#L3103">core/src/__clients__/core.ts:3103</a></p>

<H3Bordered text="Parameters" />

<ParamField body="params" type='RemoveOauthProvidersParams' required={true} >
