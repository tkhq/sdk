...
<p><strong>Defined in:</strong> <a href="https://github.com/tkhq/sdk/blob/main/packages/core/src/__clients__/core.ts#L819">core/src/__clients__/core.ts:819</a></p>

<H3Bordered text="Parameters" />

<ParamField body="params" type='SignUpWithWalletParams' required={true} >
...
<ResponseField name="returns" type="WalletAuthResult" required={true} >
  ...
  <Expandable title="return details">
    <NestedParam parentKey="returns" childKey="address" type='string' required={true}></NestedParam>
