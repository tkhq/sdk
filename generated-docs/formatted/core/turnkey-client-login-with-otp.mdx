...
<ul>
  <li>
    This function logs in a user using the verification token received after OTP
    verification (from email or SMS).
  </li>
  <li>
    If a public key is not provided, a new API key pair will be generated for
    authentication.
  </li>
  <li>
    Optionally invalidates any existing sessions for the user if
    ``invalidateExisting`` is set to true.
  </li>
  <li>
...
<p>
  ...
  <a href="https://github.com/tkhq/sdk/blob/main/packages/core/src/__clients__/core.ts#L1268">
    core.ts:1268
  </a>
</p>
...
<ParamField body="params" type="object" required={true} path="params">
  <Expandable title="params details">
    ...
    <NestedParam
      ...
      required={false}
    >
      public key to use for authentication. If not provided, a new key pair will
      be generated.
    </NestedParam>
    <NestedParam
      parentKey="params"
