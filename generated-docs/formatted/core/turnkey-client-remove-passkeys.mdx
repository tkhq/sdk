...
<ul>
  <li>
    This function removes passkeys (WebAuthn/FIDO2 authenticators) from the
    user's account.
  </li>
  <li>
    If a userId is provided, it removes the passkeys for that specific user;
...
<p>
  ...
  <a href="https://github.com/tkhq/sdk/blob/main/packages/core/src/__clients__/core.ts#L2976">
    core.ts:2976
  </a>
</p>
...
<ParamField body="params" type="object" required={true} path="params">
  <Expandable title="params details">
    ...
    <NestedParam
      ...
      required={false}
    >
      user ID to remove the passkeys for a specific user (defaults to the
