...
<p>
  ...
  <a href="https://github.com/tkhq/sdk/blob/main/packages/core/src/__clients__/core.ts#L625">
    core.ts:625
  </a>
</p>
...
<ParamField body="params" type="object" required={true} path="params">
  <Expandable title="params details">
    <NestedParam
      parentKey="params"
      childKey="chainOrId"
      type="string | SwitchableChain"
      required={true}
    >
      The target chain, specified as a chain ID string or a SwitchableChain
      object.
    </NestedParam>
    <NestedParam
      parentKey="params"
    ...
    <NestedParam
      ...
      required={false}
    >
      Optional list of wallet providers to search; falls back to
      `fetchWalletProviders()` if omitted.
    </NestedParam>
  </Expandable>
</ParamField>
