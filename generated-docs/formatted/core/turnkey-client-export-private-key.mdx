...
<p><strong>Defined in:</strong> <a href="https://github.com/tkhq/sdk/blob/main/packages/core/src/__clients__/core.ts#L3514">core/src/__clients__/core.ts:3514</a></p>

<H3Bordered text="Parameters" />

<ParamField body="params" type='ExportPrivateKeyParams' required={true} >
