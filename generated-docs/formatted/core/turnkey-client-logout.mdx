...
<ul>
  <li>
    This function clears the specified session and removes any associated key
    pairs from storage.
  </li>
  <li>
    If a sessionKey is provided, it logs out from that session; otherwise, it
...
<p>
  ...
  <a href="https://github.com/tkhq/sdk/blob/main/packages/core/src/__clients__/core.ts#L270">
    core.ts:270
  </a>
</p>
...
<ParamField body="params" type="object" required={false} path="params">
  <Expandable title="params details">
    <NestedParam
      ...
      required={false}
    >
      session key to specify which session to log out from (defaults to the
      active session).
    </NestedParam>
  </Expandable>
</ParamField>
