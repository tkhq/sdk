...
<p>
  ...
  <a href="https://github.com/tkhq/sdk/blob/main/packages/react-wallet-kit/src/providers/client/Types.tsx#L94">
    react-wallet-kit/src/providers/client/Types.tsx:94
  </a>
</p>
...
<ul>
  <li>
    This function fetches the latest list of wallets associated with the current
    session or user,
  </li>
</ul>
...
<ul>
  ...
  <li>
    Typically used after wallet creation, import, export, account changes, or
    authentication
  </li>
</ul>
...
<ResponseField name="returns" type="void" required={true}>
  A promise that resolves when the wallets are successfully refreshed and state
  is updated.
</ResponseField>
