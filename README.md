...
| [`with-solana`](/examples/with-solana/)                                | Create a new Solana address, then sign and broadcast a transaction on Solana's devnet. Also includes SPL token creation + transfer, and Jupiter swaps |     |
