...
export class TurnkeySDKClientBase {
  ...
  async activityDecision<TBodyType, TResponseType>(
	...
	getClaimEarnFeesStatus = async (input: SdkApiTypes.TGetClaimEarnFeesStatusBody): Promise<SdkApiTypes.TGetClaimEarnFeesStatusResponse> => {
	...
	stampGetClaimEarnFeesStatus = async (input: SdkApiTypes.TGetClaimEarnFeesStatusBody): Promise<TSignedRequest | undefined> => {
    if (!this.stamper) {
      return undefined;
    }
	...
	getSwapStatus = async (input: SdkApiTypes.TGetSwapStatusBody): Promise<SdkApiTypes.TGetSwapStatusResponse> => {
	...
	stampGetSwapStatus = async (input: SdkApiTypes.TGetSwapStatusBody): Promise<TSignedRequest | undefined> => {
    if (!this.stamper) {
      return undefined;
    }
	...
	getTvcQosVersions = async (input: SdkApiTypes.TGetTvcQosVersionsBody): Promise<SdkApiTypes.TGetTvcQosVersionsResponse> => {
	...
	stampGetTvcQosVersions = async (input: SdkApiTypes.TGetTvcQosVersionsBody): Promise<TSignedRequest | undefined> => {
    if (!this.stamper) {
      return undefined;
    }
	...
	listSecrets = async (input: SdkApiTypes.TListSecretsBody): Promise<SdkApiTypes.TListSecretsResponse> => {
	...
	stampListSecrets = async (input: SdkApiTypes.TListSecretsBody): Promise<TSignedRequest | undefined> => {
    if (!this.stamper) {
      return undefined;
    }
	...
	claimSwapFees = async (input: SdkApiTypes.TClaimSwapFeesBody): Promise<SdkApiTypes.TClaimSwapFeesResponse> => {
    const { organizationId, timestampMs, ...rest } = input;
	...
	stampClaimSwapFees = async (input: SdkApiTypes.TClaimSwapFeesBody): Promise<TSignedRequest | undefined> => {
    if (!this.stamper) {
      return undefined;
    }
	...
	createSwapQuote = async (input: SdkApiTypes.TCreateSwapQuoteBody): Promise<SdkApiTypes.TCreateSwapQuoteResponse> => {
    const { organizationId, timestampMs, ...rest } = input;
	...
	stampCreateSwapQuote = async (input: SdkApiTypes.TCreateSwapQuoteBody): Promise<TSignedRequest | undefined> => {
    if (!this.stamper) {
      return undefined;
    }
	...
	ethUndelegate7702 = async (input: SdkApiTypes.TEthUndelegate7702Body): Promise<SdkApiTypes.TEthUndelegate7702Response> => {
    const { organizationId, timestampMs, ...rest } = input;
	...
	stampEthUndelegate7702 = async (input: SdkApiTypes.TEthUndelegate7702Body): Promise<TSignedRequest | undefined> => {
    if (!this.stamper) {
      return undefined;
    }
	...
	executeSwap = async (input: SdkApiTypes.TExecuteSwapBody): Promise<SdkApiTypes.TExecuteSwapResponse> => {
    const { organizationId, timestampMs, ...rest } = input;
	...
	stampExecuteSwap = async (input: SdkApiTypes.TExecuteSwapBody): Promise<TSignedRequest | undefined> => {
    if (!this.stamper) {
      return undefined;
    }
	...
	exportSecrets = async (input: SdkApiTypes.TExportSecretsBody): Promise<SdkApiTypes.TExportSecretsResponse> => {
    const { organizationId, timestampMs, ...rest } = input;
	...
	stampExportSecrets = async (input: SdkApiTypes.TExportSecretsBody): Promise<TSignedRequest | undefined> => {
    if (!this.stamper) {
      return undefined;
    }
	...
	importSecrets = async (input: SdkApiTypes.TImportSecretsBody): Promise<SdkApiTypes.TImportSecretsResponse> => {
    const { organizationId, timestampMs, ...rest } = input;
	...
	stampImportSecrets = async (input: SdkApiTypes.TImportSecretsBody): Promise<TSignedRequest | undefined> => {
    if (!this.stamper) {
      return undefined;
    }
	...
	upsertSwapConfig = async (input: SdkApiTypes.TUpsertSwapConfigBody): Promise<SdkApiTypes.TUpsertSwapConfigResponse> => {
    const { organizationId, timestampMs, ...rest } = input;
	...
	stampUpsertSwapConfig = async (input: SdkApiTypes.TUpsertSwapConfigBody): Promise<TSignedRequest | undefined> => {
    if (!this.stamper) {
      return undefined;
    }
