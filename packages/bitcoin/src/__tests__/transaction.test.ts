import { largestUTXOValueFirst, selectInputUTXOs, smallestUTXOValueFirst } from "../transaction";
...
describe("selectInputUTXOs", () => {
    ...
    it("should select the inputs based on the order they come in", () => {
        ...
        expect(selectInputUTXOs([
            input50,
            input30,
            input20,
        ], 70)).toEqual([
            [input50, input30], 10n, [input20]
        ])
