...
export type v1GetAccountRequest = {
...
export type v1InitOtpV2Request = {
...
export type v1InitOtpV2Response = {
...
export type v1OauthProviderParamsV2 = {
  /** Human-readable name to identify a Provider. */
  providerName: string;
} & ({ /** Base64 encoded OIDC token */ oidcToken: string } | { /** OIDC claims (iss, sub, aud) to uniquely identify the user */ oidcClaims: v1OidcClaims });
...
export type v1OtpLoginV2Request = {
...
export type v1OtpLoginV2Response = {
...
export type v1SignupV2Response = {
  organizationId: string;
  /** Wallet created for the sub-organization, if provided in the request */
  wallet?: v1WalletResult;
  /** Root user ID created for this sub-organization */
...
export type v1VerifyOtpV2Request = {
...
export type v1VerifyOtpV2Response = {
...
export type v1CreateTvcManifestApprovalsRequest = {
...
export type v1DeleteTvcAppAndDeploymentsIntent = {
  /** The unique identifier of the TVC app to delete. The app and all associated deployments will be removed. */
  appId: string;
};

export type v1DeleteTvcAppAndDeploymentsRequest = {
  type: "ACTIVITY_TYPE_DELETE_TVC_APP_AND_DEPLOYMENTS";
  /** Timestamp (in milliseconds) of the request, used to verify liveness of user requests. */
  timestampMs: string;
  /** Unique identifier for a given Organization. */
  organizationId: string;
  parameters: v1DeleteTvcAppAndDeploymentsIntent;
  generateAppProofs?: boolean;
};

export type v1DeleteTvcAppAndDeploymentsResult = {
  /** The unique identifier of the deleted TVC app. */
  appId: string;
};

export type v1DeleteTvcDeploymentIntent = {
  /** The unique identifier of the TVC deployment to delete. */
  deploymentId: string;
};

export type v1DeleteTvcDeploymentRequest = {
  type: "ACTIVITY_TYPE_DELETE_TVC_DEPLOYMENT";
  /** Timestamp (in milliseconds) of the request, used to verify liveness of user requests. */
  timestampMs: string;
  /** Unique identifier for a given Organization. */
  organizationId: string;
  parameters: v1DeleteTvcDeploymentIntent;
  generateAppProofs?: boolean;
};

export type v1DeleteTvcDeploymentResult = {
...
export type v1ExportSecretParams = {
...
export type v1ExportSecretsIntent = {
  /** A list of secrets to export. */
  secrets: v1ExportSecretParams[];
};

export type v1ExportSecretsRequest = {
  type: "ACTIVITY_TYPE_EXPORT_SECRETS";
  /** Timestamp (in milliseconds) of the request, used to verify liveness of user requests. */
  timestampMs: string;
  /** Unique identifier for a given Organization. */
  organizationId: string;
  parameters: v1ExportSecretsIntent;
};

export type v1ExportSecretsResult = {
...
export type v1GetTvcAppDeploymentsResponse = {
  /** List of deployments for this TVC App */
  tvcDeployments: v1TvcDeployment[];
};

export type v1GetTvcAppRequest = {
  /** Unique identifier for a given organization. */
  organizationId: string;
  /** Unique identifier for a given TVC App. */
  tvcAppId: string;
...
export type v1GetTvcAppResponse = {
...
export type v1GetTvcDeploymentResponse = {
...
export type v1GetTvcQosVersionsResponse = {
...
export type v1ImportSecretParams = {
  ...
  staticProperties?: v1KeyValue[];
};

export type v1ImportSecretsIntent = {
  /** A list of secrets to import. */
  secrets: v1ImportSecretParams[];
};

export type v1ImportSecretsRequest = {
  type: "ACTIVITY_TYPE_IMPORT_SECRETS";
  /** Timestamp (in milliseconds) of the request, used to verify liveness of user requests. */
  timestampMs: string;
  /** Unique identifier for a given Organization. */
  organizationId: string;
  parameters: v1ImportSecretsIntent;
};

export type v1ImportSecretsResult = {
...
export type v1Intent = {
  ...
  updateTvcAppLiveDeploymentIntent?: v1UpdateTvcAppLiveDeploymentIntent;
  deleteTvcDeploymentIntent?: v1DeleteTvcDeploymentIntent;
  deleteTvcAppAndDeploymentsIntent?: v1DeleteTvcAppAndDeploymentsIntent;
  restoreTvcDeploymentIntent?: v1RestoreTvcDeploymentIntent;
  sparkSignFrostIntent?: v1SparkSignFrostIntent;
  sparkPrepareTransferIntent?: v1SparkPrepareTransferIntent;
...
export type v1ListSecretsRequest = {
...
export type v1QuorumKeyShareApprovalBundle = {
...
export type v1RestoreTvcDeploymentRequest = {
  type: "ACTIVITY_TYPE_RESTORE_TVC_DEPLOYMENT";
  /** Timestamp (in milliseconds) of the request, used to verify liveness of user requests. */
  timestampMs: string;
  /** Unique identifier for a given Organization. */
  organizationId: string;
  parameters: v1RestoreTvcDeploymentIntent;
  generateAppProofs?: boolean;
};

export type v1RestoreTvcDeploymentResult = {
...
export type v1Result = {
  ...
  updateTvcAppLiveDeploymentResult?: v1UpdateTvcAppLiveDeploymentResult;
  deleteTvcDeploymentResult?: v1DeleteTvcDeploymentResult;
  deleteTvcAppAndDeploymentsResult?: v1DeleteTvcAppAndDeploymentsResult;
  restoreTvcDeploymentResult?: v1RestoreTvcDeploymentResult;
  sparkSignFrostResult?: v1SparkSignFrostResult;
  sparkPrepareTransferResult?: v1SparkPrepareTransferResult;
...
export type v1SparkClaimTransferIntent = {
  /** A Spark wallet account address identifying the wallet. */
  signWith: string;
  /** Claim package parameters. */
  claim: v1SparkClaimPackage;
};

export type v1SparkClaimTransferRequest = {
  type: "ACTIVITY_TYPE_SPARK_CLAIM_TRANSFER";
  /** Timestamp (in milliseconds) of the request, used to verify liveness of user requests. */
  timestampMs: string;
  /** Unique identifier for a given Organization. */
  organizationId: string;
  parameters: v1SparkClaimTransferIntent;
};

export type v1SparkClaimTransferResult = {
  /** Per-operator ECIES-encrypted packages. */
  operatorPackages: v1SparkEncryptedOperatorPackage[];
  /** Newly-derived SigningLeaf public keys, one per leaf, in input order. */
  newLeafPublicKeys: v1SparkLeafPublicKey[];
};

export type v1SparkDepositDerivation = {};
export type v1SparkEncryptedOperatorPackage = {
...
export type v1SparkFrostCommitment = {
...
export type v1SparkHtlcPreimageDerivation = {};
export type v1SparkIdentityDerivation = {};
export type v1SparkKeyDerivation = {
  /** Spark identity key derivation. */
  identity?: v1SparkIdentityDerivation;
  /** Spark signing leaf key derivation, identified by leaf ID. */
  signingLeaf?: v1SparkSigningLeafDerivation;
  /** Spark deposit key derivation. */
  deposit?: v1SparkDepositDerivation;
  /** Spark static deposit key derivation, identified by index. */
  staticDeposit?: v1SparkStaticDepositDerivation;
  /** Spark HTLC preimage key derivation. */
  htlcPreimage?: v1SparkHtlcPreimageDerivation;
};

export type v1SparkLeafPublicKey = {
...
export type v1SparkLightningReceivePackage = {
...
export type v1SparkOperatorRecipient = {
  /** Spark operator identifier (UUID). */
  operatorId: string;
...
export type v1SparkPartialSignature = {
...
export type v1SparkPrepareLightningReceiveIntent = {
  /** A Spark wallet account address identifying the wallet. */
  signWith: string;
  /** Lightning receive package parameters: threshold and operator recipients. */
  lightningReceive: v1SparkLightningReceivePackage;
};

export type v1SparkPrepareLightningReceiveRequest = {
  type: "ACTIVITY_TYPE_SPARK_PREPARE_LIGHTNING_RECEIVE";
  /** Timestamp (in milliseconds) of the request, used to verify liveness of user requests. */
  timestampMs: string;
  /** Unique identifier for a given Organization. */
  organizationId: string;
  parameters: v1SparkPrepareLightningReceiveIntent;
};
...
export type v1SparkPrepareTransferIntent = {
  /** A Spark wallet account address identifying the wallet. */
  signWith: string;
  /** Transfer package parameters for HD key tweak splitting. */
  transfer: v1SparkTransferPackage;
};

export type v1SparkPrepareTransferRequest = {
  type: "ACTIVITY_TYPE_SPARK_PREPARE_TRANSFER";
  /** Timestamp (in milliseconds) of the request, used to verify liveness of user requests. */
  timestampMs: string;
  /** Unique identifier for a given Organization. */
  organizationId: string;
  parameters: v1SparkPrepareTransferIntent;
};

export type v1SparkPrepareTransferResult = {
  /** Per-operator ECIES-encrypted packages. */
  operatorPackages: v1SparkEncryptedOperatorPackage[];
...
export type v1SparkSignFrostIntent = {
  ...
  signatures: v1SparkSignatureRequest[];
};

export type v1SparkSignFrostRequest = {
  type: "ACTIVITY_TYPE_SPARK_SIGN_FROST";
  /** Timestamp (in milliseconds) of the request, used to verify liveness of user requests. */
  timestampMs: string;
  /** Unique identifier for a given Organization. */
  organizationId: string;
  parameters: v1SparkSignFrostIntent;
};

export type v1SparkSignFrostResult = {
  /** Partial signatures plus Turnkey commitments, one per request, in order. */
  signatures: v1SparkPartialSignature[];
};

export type v1SparkSignatureRequest = {
  /** Which key to sign with. */
  derivation: v1SparkKeyDerivation;
  ...
  operatorCommitments: v1SparkFrostCommitment[];
...
export type v1SparkTransferLeaf = {
  ...
  newLeafDerivation: v1SparkKeyDerivation;
...
export type v1SparkTransferPackage = {
  /** Spark transfer identifier (UUID). */
  transferId: string;
  /** Leaves being transferred. */
  leaves: v1SparkTransferLeaf[];
...
export type v1UpdateTvcAppLiveDeploymentIntent = {
  /** The unique identifier of the TVC deployment to set as live for the app. */
  deploymentId: string;
};

export type v1UpdateTvcAppLiveDeploymentRequest = {
  type: "ACTIVITY_TYPE_UPDATE_TVC_APP_LIVE_DEPLOYMENT";
  /** Timestamp (in milliseconds) of the request, used to verify liveness of user requests. */
  timestampMs: string;
  /** Unique identifier for a given Organization. */
  organizationId: string;
  parameters: v1UpdateTvcAppLiveDeploymentIntent;
  generateAppProofs?: boolean;
};

export type v1UpdateTvcAppLiveDeploymentResult = {};
...
export type v1ValidateTvcImageRequest = {
  /** Unique identifier for a given Organization. */
  organizationId: string;
...
export type v1ValidateTvcImageResponse = {
...
export type ProxyTGetWalletKitClientParamsInput = { body: ProxyTGetWalletKitClientParamsBody };
