  ...
  return (
    <div> 
      ...
      <div className={styles.loadingWrapper}>
        ...
        {oauthLoading === "Google" && <GoogleIcon className={styles.oauthIcon} />}
        {oauthLoading === "Facebook" && <FacebookIcon className={styles.oauthIcon} />}
        {oauthLoading === "Apple" && <AppleIcon className={styles.oauthIcon} />}
      </div>
...
{!otpId && authConfig.facebookEnabled && authIframeClient && (
    <div className = {styles.authButton}>
    <div className={styles.socialButtonContainer}>
    <FacebookAuthButton clientId = {process.env.NEXT_PUBLIC_FACEBOOK_CLIENT_ID!} iframePublicKey={authIframeClient.iframePublicKey!} onSuccess={handleFacebookLogin} />
  </div>
  </div>
)}
