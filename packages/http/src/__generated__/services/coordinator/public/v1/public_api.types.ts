...
export type paths = {
  ...
  "/public/v1/submit/create_oauth_session": {
    /** Create an Oauth session for a user */
    post: operations["PublicApiService_CreateOauthSession"];
  };
  "/public/v1/submit/create_otp_session": {
    /** Create an OTP session for a user */
    post: operations["PublicApiService_CreateOtpSession"];
  };
  "/public/v1/submit/create_passkey_session": {
    /** Create a Passkey session for a user */
    post: operations["PublicApiService_CreatePasskeySession"];
  };
...
export type definitions = {
  ...
  v1ActivityType:
    ...
    | "ACTIVITY_TYPE_CREATE_OTP_SESSION"
    | "ACTIVITY_TYPE_CREATE_PASSKEY_SESSION"
    | "ACTIVITY_TYPE_CREATE_OAUTH_SESSION";
  /** @enum {string} */
  v1AddressFormat:
  ...
  v1CreateOauthSessionIntent: {
    ...
    publicKey: string;
    /** @description Expiration window (in seconds) indicating how long the Session (api key in org data) is valid. If not provided, a default of 15 minutes will be used. */
    expirationSeconds?: string;
    /** @description Invalidate all other previously generated Passkey Session API keys */
    invalidateExisting?: boolean;
  };
  v1CreateOauthSessionRequest: {
    /** @enum {string} */
    ...
    /** @description Unique identifier for a given Organization. */
    organizationId: string;
    parameters: definitions["v1CreateOauthSessionIntent"];
  };
  v1CreateOauthSessionResult: {
  ...
  v1CreateOtpSessionIntent: {
    ...
    /** @description Expiration window (in seconds) indicating how long the Session (api key in org data) is valid. If not provided, a default of 15 minutes will be used. */
    expirationSeconds?: string;
    /** @description Invalidate all other previously generated OTP Session API keys */
    invalidateExisting?: boolean;
  };
  v1CreateOtpSessionRequest: {
    /** @enum {string} */
    ...
    /** @description Unique identifier for a given Organization. */
    organizationId: string;
    parameters: definitions["v1CreateOtpSessionIntent"];
  };
  v1CreateOtpSessionResult: {
    /** @description Signed JWT containing an expiry, public key, session type, user id, and organization id */
    session: string;
  };
  v1CreatePasskeySessionIntent: {
  ...
  v1CreatePasskeySessionRequest: {
    ...
    /** @description Unique identifier for a given Organization. */
    organizationId: string;
    parameters: definitions["v1CreatePasskeySessionIntent"];
  };
  v1CreatePasskeySessionResult: {
    /** @description Signed JWT containing an expiry, public key, session type, user id, and organization id */
    session: string;
  };
  ...
  v1CredentialType:
    ...
    | "CREDENTIAL_TYPE_OTP_SESSION"
    | "CREDENTIAL_TYPE_PASSKEY_SESSION"
    | "CREDENTIAL_TYPE_OAUTH_SESSION";
  /** @enum {string} */
  ...
  v1Intent: {
    ...
    createOtpSessionIntent?: definitions["v1CreateOtpSessionIntent"];
    createPasskeySessionIntent?: definitions["v1CreatePasskeySessionIntent"];
    createOauthSessionIntent?: definitions["v1CreateOauthSessionIntent"];
  };
  v1Invitation: {
    /** @description Unique identifier for a given Invitation object. */
    invitationId: string;
  ...
  v1Result: {
    ...
    createOtpSessionResult?: definitions["v1CreateOtpSessionResult"];
    createPasskeySessionResult?: definitions["v1CreatePasskeySessionResult"];
    createOauthSessionResult?: definitions["v1CreateOauthSessionResult"];
  };
  v1RootUserParams: {
    /** @description Human-readable name for a User. */
    userName: string;
  ...
  v1VerifyOtpIntent: {
    ...
    /** @description OTP sent out to a user's contact (email or SMS) */
    otpCode: string;
    /** @description Expiration window (in seconds) indicating how long the verification token is valid. If not provided, a default of 5 minutes will be used. */
    expirationSeconds?: string;
  };
  v1VerifyOtpRequest: {
    /** @enum {string} */
...
export type operations = {
  ...
  /** Create an Oauth session for a user */
  PublicApiService_CreateOauthSession: {
    parameters: {
      body: {
        body: definitions["v1CreateOauthSessionRequest"];
      };
    };
    responses: {
      /** A successful response. */
  ...
  /** Create an OTP session for a user */
  PublicApiService_CreateOtpSession: {
    parameters: {
      body: {
        body: definitions["v1CreateOtpSessionRequest"];
      };
    };
    responses: {
      /** A successful response. */
  ...
  /** Create a Passkey session for a user */
  PublicApiService_CreatePasskeySession: {
    parameters: {
      body: {
        body: definitions["v1CreatePasskeySessionRequest"];
      };
    };
    responses: {
      /** A successful response. */
