...
export type paths = {
  ...
  "/public/v1/submit/create_oauth_providers": {
    /** Creates Oauth providers for a specified user */
  ...
  "/public/v1/submit/delete_oauth_providers": {
    /** Removes Oauth providers for a specified user */
...
export type definitions = {
  ...
  v1OauthIntent: {
    ...
    oidcToken: string;
    /** @description Client-side public key generated by the user, to which the oidc auth bundle (credentials) will be encrypted. */
    targetPublicKey: string;
