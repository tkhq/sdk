...
export const TURNKEY_OAUTH_ORIGIN_URL =
  "https://oauth-origin.preprod.turnkey.engineering"; // TODO: we need to change this when we go deploy to prod
export const TURNKEY__OAUTH_REDIRECT_URL =
  "https://oauth-redirect.preprod.turnkey.engineering"; // TODO: we need to change this when we go deploy to prod
