...
const PUBLIC_API_SWAGGER_PATH = path.resolve(`${SOURCE_DIRECTORY}/__inputs__`, "public_api.swagger.json");
const TARGET_API_TYPES_PATH = path.resolve(`${SOURCE_DIRECTORY}/__generated__`, "sdk_api_types.ts");
const TARGET_SDK_CLIENT_PATH = path.resolve(`${SOURCE_DIRECTORY}/__generated__`, "sdk-client-base.ts");
...
const VERSIONED_ACTIVITY_TYPES = {
  ...
  "ACTIVITY_TYPE_CREATE_SUB_ORGANIZATION": "ACTIVITY_TYPE_CREATE_SUB_ORGANIZATION_V4",
