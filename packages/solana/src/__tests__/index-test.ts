...
describe("TurnkeySigner", () => {
  test("can sign a Solana transfer against production", async () => {
      if (!process.env.SOLANA_TEST_ORG_API_PRIVATE_KEY) {
        ...
        console.warn("This test is skipped because it cannot run without SOLANA_TEST_ORG_API_PRIVATE_KEY set")
        return;
      }
      ...
      const client = new TurnkeyClient(
        ...
        new ApiKeyStamper({
        apiPublicKey: "025d374c674fc389c761462f3c59c0acabdcb3a17c599d9e62e5fe78fe984cfbeb",
      ...
      transferTransaction.recentBlockhash = "GZSq3KvoFVhE22CQsaWSAxBoAvRiZSs7xVNa6yPecMUu";
