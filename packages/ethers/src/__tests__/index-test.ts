...
describe("TurnkeySigner", () => {
  ...
  // NOTE: commenting this out until Ethers v6 has an implementation of Eip1193Bridge.
  // If this is a critical feature for you, please use our Ethers v5 implementation.
  //
